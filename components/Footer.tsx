        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com/businesshub" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Visit us on Twitter">
              ...
              <a href="https://facebook.com/businesshub" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Visit us on Facebook">
              ...
              <a href="https://instagram.com/businesshub" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Visit us on Instagram">
